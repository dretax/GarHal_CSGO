...
5. Optional: Clear the MmUnloadedDrivers and PIBCache yourself, don't use CreateDriver, hook an IOCTL function with a trick, or do some other type of communication.
